...
%'FillGap' — Distance between two line segments associated with the same Hough transform bin 20 (default) | positive real scalar
%'MinLength' — Minimum line length 40 (default) | positive real scalar
